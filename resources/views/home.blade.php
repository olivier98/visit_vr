                        ...
                        <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                            @auth
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <x-dropdown-link :href="route('logout')" class="btn custom-btn d-lg-block"
                            ...
                            @else
                                <a href="{{ route('login') }}"
                                    class="btn custom-btn d-lg-block d-none">{{ __('Connexion') }}</a>
                            @endauth
                        </div>
                    @endif
    ...
    <div id="intro" class="bg-dark bg-gradient vh-100 shadow-1-strong">
        <div class="container d-flex align-items-center justify-content-center text-center h-100">
            <div class="text-white">
                ...
                <a class="btn btn-outline-light btn-lg m-2" href="/visitor-sign-in" role="button" rel="nofollow"
                    target="_blank">Start Visit</a>
